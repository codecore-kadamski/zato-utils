...
echo "Copying Certificates over"
# web admin
cp *web_admin* ../web-admin/ca/
cp ca_cert.pem ../web-admin/ca/

# cluster load balancer
cp *load_balancer* ../cluster/ca/
cp ca_cert.pem ../cluster/ca/

# cluster servers
cp *server* ../cluster/ca/
cp ca_cert.pem ../cluster/ca/
